...
MM_BLACK:
    ; This is the middle sensor for the black color
    CLRF    CALC_reg
    MOVLW   00000001B
    MOVWF   ADCON0
...
RESOLUTION_BLACK:
    ...
    ; Check each sensor sequentially for if it is black
    BTFSC   BLACK_reg, 2
    GOTO    STRAIGHT
    BTFSC   BLACK_reg, 1
    GOTO    MID_RIGHT
